...
public class CreatePostTest {
    ...
    public void postCreateTest() {
        ...
        PostModelBD postBD = new PostsSqlSteps(connection).getPostModelBD(postsCreateResponse.getId());
        connection.close();

        PostConvertPojo postConvertPojo = PostConvertPojo.from(postsCreateResponse);
